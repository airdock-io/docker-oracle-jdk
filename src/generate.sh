...
generateReadMe() {
    ...
    readme="${readme}###Latest tag per version and type${NL}"
		...
		readme="${readme} - [${FULLNAME}:jre-1.8](https://github.com/airdock-io/docker-oracle-jdk/tree/master/jre-1.8) (${TAG_JRE_8}) [![](https://badge.imagelayers.io/airdock/oracle-jdk:1.8.svg)](https://imagelayers.io/?images=airdock/oracle-jdk:1.8 'Get your own badge on imagelayers.io')${NL}"
		readme="${readme} - [${FULLNAME}:1.7](https://github.com/airdock-io/docker-oracle-jdk/tree/master/jdk-1.7) (${TAG_JDK_7}) [![](https://badge.imagelayers.io/airdock/oracle-jdk:1.7.svg)](https://imagelayers.io/?images=airdock/oracle-jdk:1.7 'Get your own badge on imagelayers.io')${NL}"
		readme="${readme} - [${FULLNAME}:jre-1.7](https://github.com/airdock-io/docker-oracle-jdk/tree/master/jre-1.7) (${TAG_JRE_7}) [![](https://badge.imagelayers.io/airdock/oracle-jdk:1.7.svg)](https://imagelayers.io/?images=airdock/oracle-jdk:1.7 'Get your own badge on imagelayers.io')${NL}${NL}${NL}"
